...
async def download_user_study_geoms(
    ...
    return FileResponse(
        path=zip_temp_path,
        filename=os.path.basename(f"{study}_link_tool_geoms_{username}.zip"),
